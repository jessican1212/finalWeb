...
async function getRecentlyPlayed() {
    ...
    if (response.status == 200) {
        ...
        let day = data['items'][0]['played_at']
        day = day.substring(0, 10)
        document.getElementById("lastSong").innerHTML = songTitle
        document.getElementById("lastArtist").innerHTML = songArtist+" on "+day +", which has a popularity rating of "+pop+" out of 100 Spotify units"
